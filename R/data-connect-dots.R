...
#' various dots. The original text is under a Creative Commons Attribution-
#' NoDerivs 3.0 Unported license (CC BY-ND 3.0). The text has not been modified.
#' 
#'
#'
#'
