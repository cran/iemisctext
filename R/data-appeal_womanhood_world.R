...
#'
#' @source
#' Julia Ward Howe, "Appeal to Womanhood Throughout the World", September 1870, Boston, Massachusetts. See \url{https://www.loc.gov/resource/rbpe.07400300}.
#'
#'
#'
#'
